...
Currently: Wave 4 - T39 done (the ops order and procurement boards, and the one screen where
both sides of a trade sit together); T35 next in this lane. **T24 done** - the buyer's own seal check at handover, and returns inside the 48-hour window; platform.return_request has a writer at last
