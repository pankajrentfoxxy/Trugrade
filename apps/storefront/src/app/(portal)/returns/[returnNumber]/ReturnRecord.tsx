      ...
      <RecordHeader
        ...
        identifiers={[
          ...
          { label: 'Return', value: r.returnNumber },
          {
            label: 'Order',
            value: r.orderNumber || '—',
            href: r.orderNumber ? `/orders/${encodeURIComponent(r.orderNumber)}` : undefined,
          },
      ...
      <div className="rec crrec">
        ...
        >
          ...
          */}
          ...
          <a className="pill wire crside-a" href="/returns">
            All your returns
          </a>
        </SidePanel>
      </div>
    ...
    <div className="ostate">
      <EmptyState
        ...
        action={
          <a
            className="pill acc"
            href={`/sign-in?next=${encodeURIComponent(`/returns/${returnNumber}`)}`}
          >
            Sign in
          </a>
        }
  ...
  return (
    <div className="ostate">
      <EmptyState
        ...
        action={
          <a className="pill acc" href="/returns">
            Your returns
          </a>
        }
      />
