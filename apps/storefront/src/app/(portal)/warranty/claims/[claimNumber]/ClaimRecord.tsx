    ...
    <>
      <RecordHeader
        ...
        identifiers={[
          ...
          { label: 'Claim', value: c.claimNumber },
          {
            label: 'Order',
            value: c.orderNumber || '—',
            href: c.orderNumber ? `/orders/${encodeURIComponent(c.orderNumber)}` : undefined,
          },
      ...
      <div className="rec crrec">
        ...
        >
          ...
          <a className="pill wire crside-a" href="/warranty">
            Back to warranty
          </a>
        </SidePanel>
      </div>
    ...
    <div className="ostate">
      <EmptyState
        ...
        action={
          <a
            className="pill acc"
            href={`/sign-in?next=${encodeURIComponent(`/warranty/claims/${claimNumber}`)}`}
          >
            Sign in
          </a>
        }
  ...
  return (
    <div className="ostate">
      <EmptyState
        ...
        action={
          <a className="pill acc" href="/warranty">
