...
/**
 * The public interface of the `customer` module.
 *
 * This interface is the future network contract (02_ARCHITECTURE.md §1.1 rule 4).
 * When `customer` is extracted into its own service the folder moves, the in-process
 ...
 *
 * Owns: buyer profiles, preferences, approval policies, credit applications, saved searches
 *
 * Other modules reach this through `src/modules/customer` (the barrel) and nothing
