...
/**
 * The public interface of the `procurement` module.
 *
 * This interface is the future network contract (02_ARCHITECTURE.md §1.1 rule 4).
 * When `procurement` is extracted into its own service the folder moves, the in-process
 ...
 *
 * Owns: purchase orders, PO lines, vendor invoices, goods receipts, vendor payables, payout runs, margin rules, price books, TDS ledger
 *
 * Other modules reach this through `src/modules/procurement` (the barrel) and nothing
