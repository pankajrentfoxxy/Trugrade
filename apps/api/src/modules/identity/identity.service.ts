 ...
 * When `identity` is extracted into its own service the folder moves, the in-process
 ...
 *
 * Owns: organizations, users, roles, permissions, sessions, OTP, addresses, contacts, audit log, pincode master
 *
 * Other modules reach this through `src/modules/identity` (the barrel) and nothing
